...
.PHONY: help install update-deps check test test-coverage test-links test-smoke clean clean-full lint autocorrect format lint-markdown lint-markdown-check inspector compile-docs docs-serve docs-build docs-deploy test-extension test-extension-python test-extension-typescript typecheck compile upload setup
...
help:
	...
	@echo "  - lint-markdown-check - Run markdownlint (no auto-fix)"
...
lint-markdown-check:
	@echo "Running markdownlint (no auto-fix)..."
