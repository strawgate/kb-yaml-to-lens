...
.PHONY: help install update-deps check check-fix test test-coverage test-links test-smoke clean clean-full lint lint-check format format-check lint-markdown lint-markdown-check inspector compile-docs docs-serve docs-build test-extension test-extension-python test-extension-typescript typecheck compile upload setup
