...
from kb_dashboard_tools.decompile.kbn_raw_models.panels.charts.base.view import (
    KbnRawBaseStateVisualization,
    KbnRawBaseStateVisualizationLayer,
    KbnRawLegendSize,
)
from kb_dashboard_tools.decompile.kbn_raw_models.shared.view import OmitIfNone

LegendPositionType = Literal['top', 'right', 'bottom', 'left']


class KbnRawWaffleStateVisualizationLayer(KbnRawBaseStateVisualizationLayer):
    ...
    primaryGroups: list[str] | None = None
    ...
    legendDisplay: str | None = None
    """Legend display mode ('default', 'show', 'hide')."""

    nestedLegend: bool | None = None
    ...
    legendSize: Annotated[KbnRawLegendSize | None, OmitIfNone()] = Field(None)
...
class KbnRawWaffleVisualizationState(KbnRawBaseStateVisualization):
    ...
    layers: list[KbnRawWaffleStateVisualizationLayer] | None = Field(default=None)
