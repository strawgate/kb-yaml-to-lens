...
from kb_dashboard_tools.decompile.kbn_raw_models.panels.charts.base.view import KbnRawBaseStateVisualization, KbnRawLayerColorMapping
from kb_dashboard_tools.decompile.kbn_raw_models.shared.view import BaseRawVwModel, OmitIfNone

type KbnRawXYLegendSize = Literal['auto', 'small', 'medium', 'large', 'xlarge']

type KbnRawReferenceLineIcon = Literal[
    'empty',
    'alert',
    'asterisk',
    'bell',
...
class LabelsOrientationConfig(BaseRawVwModel):
...
class AxisTitlesVisibilitySettings(BaseRawVwModel):
...
class AxisExtentConfig(BaseRawVwModel):
    ...
    mode: Literal['full', 'custom', 'dataBounds'] | None = None
...
class YConfig(BaseRawVwModel):
    ...
    icon: Annotated[KbnRawReferenceLineIcon | None, OmitIfNone()] = None
...
class XYDataLayerConfig(BaseRawVwModel):
    ...
    layerType: Literal['data'] | None = None
...
class XYReferenceLineLayerConfig(BaseRawVwModel):
    ...
    layerType: Literal['referenceLine'] | None = None
    """Always 'referenceLine' for reference line layers."""


class XYAnnotationLayerConfigCachedMetadata(BaseRawVwModel):
...
class XYByValueAnnotationLayerConfig(BaseRawVwModel):
    ...
    layerType: Literal['annotations'] | None = None
    ...
    ignoreGlobalFilters: bool | None = None
...
class XYByReferenceAnnotationLayerConfig(BaseRawVwModel):
    ...
    annotationGroupId: str | None = None
...
class XYLegendConfig(BaseRawVwModel):
    ...
    legendSize: Annotated[KbnRawXYLegendSize | None, OmitIfNone()] = None
...
class KbnRawXYVisualizationState(KbnRawBaseStateVisualization):
    ...
    legend: XYLegendConfig | None = None
