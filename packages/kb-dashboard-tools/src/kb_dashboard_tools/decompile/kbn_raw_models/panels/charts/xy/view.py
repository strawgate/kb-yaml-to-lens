...
from kb_dashboard_tools.decompile.kbn_raw_models.panels.charts.base.view import KbnBaseStateVisualization, KbnLayerColorMapping
...
class XYByReferenceAnnotationLayerConfig(BaseRawVwModel):
    ...
    last_saved: Any | None = Field(default=None, alias='__lastSaved')
