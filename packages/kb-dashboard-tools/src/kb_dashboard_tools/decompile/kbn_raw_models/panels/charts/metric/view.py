...
class KbnRawSecondaryTrendNone(BaseRawVwModel):
...
class KbnRawMetricVisualizationState(BaseRawVwModel):
    ...
    secondaryTrend: Annotated[KbnRawSecondaryTrendNone | None, OmitIfNone()] = Field(default=None)
...
class KbnRawESQLMetricVisualizationState(BaseRawVwModel):
