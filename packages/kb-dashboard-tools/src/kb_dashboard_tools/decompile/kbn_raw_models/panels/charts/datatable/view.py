...
from kb_dashboard_tools.decompile.kbn_raw_models.panels.charts.base.view import KbnRawRangePalette
from kb_dashboard_tools.decompile.kbn_raw_models.shared.view import BaseRawVwModel, OmitIfNone


class KbnRawDatatableColumnState(BaseRawVwModel):
...
class KbnRawDatatableSortingState(BaseRawVwModel):
...
class KbnRawDatatablePagingState(BaseRawVwModel):
...
class KbnRawDatatableVisualizationState(BaseRawVwModel):
    """Represents the visualization state for a datatable chart.

    Maps to Kibana's DatatableVisualizationState interface.
    Note: Datatable does not use the layers structure like other visualizations. | None = None
    """

    columns: list[KbnRawDatatableColumnState] | None = Field(default=None)
    ...
    sorting: Annotated[KbnRawDatatableSortingState | None, OmitIfNone()] = Field(default=None)
    ...
    paging: Annotated[KbnRawDatatablePagingState | None, OmitIfNone()] = Field(default=None)
