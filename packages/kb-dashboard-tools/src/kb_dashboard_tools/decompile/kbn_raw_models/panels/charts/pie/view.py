...
class KbnRawPieStateVisualizationLayer(KbnRawBaseStateVisualizationLayer):
...
class KbnRawPieVisualizationState(KbnRawBaseStateVisualization):
    ...
    shape: Literal['pie', 'donut', 'treemap'] | None = None
    """Shape of the chart ('pie' for full circle, 'donut' for ring chart, or 'treemap')."""

    layers: list[KbnRawPieStateVisualizationLayer] | None = Field(default=None)
