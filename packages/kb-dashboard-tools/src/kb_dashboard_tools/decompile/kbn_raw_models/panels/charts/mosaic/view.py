...
class KbnRawMosaicStateVisualizationLayer(KbnRawBaseStateVisualizationLayer):
...
class KbnRawMosaicVisualizationState(KbnRawBaseStateVisualization):
    ...
    layers: list[KbnRawMosaicStateVisualizationLayer] | None = Field(default=None)
