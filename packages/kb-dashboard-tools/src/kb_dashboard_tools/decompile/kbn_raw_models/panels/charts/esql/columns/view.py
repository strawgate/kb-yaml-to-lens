...
class KbnRawESQLMetricFormatParams(BaseRawVwModel):
...
class KbnRawESQLMetricFormat(BaseRawVwModel):
    """The format of the ES|QL metric column."""

    id: Literal['number', 'bytes', 'bits', 'percent', 'duration', 'custom'] | None = None

    params: KbnRawESQLMetricFormatParams | None = None
    """The parameters of the format."""


type KbnRawESQLMetricFormatTypes = KbnRawESQLMetricFormat


class KbnRawESQLColumnMeta(BaseRawVwModel):
...
class KbnRawESQLFieldDimensionColumn(BaseRawVwModel):
    ...
    meta: Annotated[KbnRawESQLColumnMeta | None, OmitIfNone()] = None
    """Type metadata for the column."""


class KbnRawESQLMetricColumnParams(BaseRawVwModel):
    """Parameters for ES|QL metric column formatting."""

    format: Annotated[KbnRawESQLMetricFormatTypes | None, OmitIfNone()] = None
    """The format configuration for this metric."""


class KbnRawESQLFieldMetricColumn(BaseRawVwModel):
    """Represents a field-sourced ESQL column in the Kibana JSON structure."""
    ...
    params: Annotated[KbnRawESQLMetricColumnParams | None, OmitIfNone()] = None
    """Optional formatting parameters for the metric."""


type KbnRawESQLMetricColumnTypes = KbnRawESQLFieldMetricColumn

type KbnRawESQLDimensionColumnTypes = KbnRawESQLFieldDimensionColumn
