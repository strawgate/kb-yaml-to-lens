...
type KbnRawLegendSize = Literal['small', 'medium', 'large', 'xlarge']


class KbnRawLayerColorMappingRule(BaseRawVwModel):
...
class KbnRawLayerColorMappingColor(BaseRawVwModel):
...
class KbnRawLayerColorMappingAssignment(BaseRawVwModel):
    ...
    rule: KbnRawLayerColorMappingRule | None = Field(default=None)
    """The color mapping rule defining what values this assignment applies to."""

    color: KbnRawLayerColorMappingColor | None = Field(default=None)
...
class KbnRawLayerColorMappingSpecialAssignment(BaseRawVwModel):
...
class KbnRawLayerColorMapping(BaseRawVwModel):
    ...
    assignments: list[KbnRawLayerColorMappingAssignment] | None = Field(default=None)
    """List of manual color assignments for specific categories or series."""

    specialAssignments: list[KbnRawLayerColorMappingSpecialAssignment] | None = Field(default=None)
...
class KbnRawRangePaletteStop(BaseRawVwModel):
...
class KbnRawRangePaletteParams(BaseRawVwModel):
    ...
    stops: list[KbnRawRangePaletteStop] | None = Field(default=None)
    """Band endpoints — each entry marks the END of one band."""

    colorStops: list[KbnRawRangePaletteStop] | None = Field(default=None)
...
class KbnRawRangePalette(BaseRawVwModel):
    ...
    params: KbnRawRangePaletteParams | None = Field(default=None)
    """Palette parameters including stops and colors."""


class KbnRawBaseStateVisualizationLayer(BaseRawVwModel):
    ...
    colorMapping: Annotated[KbnRawLayerColorMapping | None, OmitIfNone()] = None
    """Optional color mapping configuration for this layer."""


class KbnRawBaseStateVisualization(BaseRawVwModel):
    ...
    layers: list[KbnRawBaseStateVisualizationLayer] | None = Field(default=None)
