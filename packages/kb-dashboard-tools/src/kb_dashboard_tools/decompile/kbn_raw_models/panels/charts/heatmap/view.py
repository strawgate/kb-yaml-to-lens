...
from kb_dashboard_tools.decompile.kbn_raw_models.panels.charts.base.view import KbnLegendSize, KbnRangePalette
from kb_dashboard_tools.decompile.kbn_raw_models.shared.view import BaseRawVwModel, OmitIfNone


class KbnHeatmapGridConfig(BaseRawVwModel):
...
class KbnHeatmapLegendConfig(BaseRawVwModel):
...
class KbnHeatmapVisualizationState(BaseRawVwModel):
