...
type KbnRawLensDimensionColumnTypes = (
    KbnRawLensDateHistogramDimensionColumn
    | KbnRawLensTermsDimensionColumn
    | KbnRawLensFiltersDimensionColumn
    | KbnRawLensIntervalsDimensionColumn
    | KbnRawLensCustomIntervalsDimensionColumn
)

type KbnRawLensMetricColumnTypes = (
    KbnRawLensFieldMetricColumn
    | KbnRawLensStaticValueColumn
    | KbnRawLensFormulaColumn
    | KbnRawLensMathColumn
    | KbnRawLensFormulaAggColumn
    | KbnRawLensFullReferenceColumn
)

type KbnRawLensMetricFormatTypes = KbnRawLensMetricFormat


class KbnRawLensMetricFormatParams(BaseRawVwModel):
...
class KbnRawLensMetricFormat(BaseRawVwModel):
    """The format of the column."""

    id: Literal['number', 'bytes', 'bits', 'percent', 'duration', 'custom'] | None = None

    params: KbnRawLensMetricFormatParams | None = None
    """The parameters of the format."""


class KbnRawLensBaseColumn(BaseRawVwModel):
    ...
    filter: Annotated[KbnRawQuery | None, OmitIfNone()] = Field(default=None)

    scale: str | None = None
    """The scale of the column, such as 'ordinal', 'ratio', 'interval', etc."""


class KbnRawLensMetricColumnParams(BaseRawVwModel):
    """Additional parameters for metric columns."""

    format: Annotated[KbnRawLensMetricFormat | None, OmitIfNone()] = Field(default=None)
...
class KbnRawLensFieldMetricColumn(KbnRawLensBaseColumn):
    ...
    params: KbnRawLensMetricColumnParams | None = None
    """Additional parameters for the metric column."""


class KbnRawLensStaticValueColumnParams(BaseRawVwModel):
...
class KbnRawLensStaticValueColumn(KbnRawLensBaseColumn):
    ...
    params: KbnRawLensStaticValueColumnParams | None = None
...
class KbnRawLensFormulaColumnParams(BaseRawVwModel):
...
class KbnRawLensFormulaColumn(KbnRawLensBaseColumn):
    ...
    params: KbnRawLensFormulaColumnParams | None = None
...
class KbnRawLensMathColumnParams(BaseRawVwModel):
...
class KbnRawLensMathColumn(KbnRawLensBaseColumn):
    ...
    params: KbnRawLensMathColumnParams | None = None
...
class KbnRawLensFormulaAggColumnParams(BaseRawVwModel):
...
class KbnRawLensFormulaAggColumn(KbnRawLensBaseColumn):
    ...
    params: KbnRawLensFormulaAggColumnParams | None = None
    """Parameters for the aggregation column."""


class KbnRawLensFullReferenceColumnParams(BaseRawVwModel):
...
class KbnRawLensFullReferenceColumn(KbnRawLensBaseColumn):
    ...
    params: KbnRawLensFullReferenceColumnParams | None = None
...
class KbnRawLensDimensionColumnParams(BaseRawVwModel):
    """Additional parameters for dimension columns."""


class KbnRawLensBaseDimensionColumn(KbnRawLensBaseColumn):
    """Base class for Lens dimension columns."""

    params: KbnRawLensDimensionColumnParams | None = None
    """Additional parameters for the dimension column."""


class KbnRawLensDateHistogramDimensionColumnParams(KbnRawLensDimensionColumnParams):
...
class KbnRawLensDateHistogramDimensionColumn(KbnRawLensBaseDimensionColumn):
    ...
    params: KbnRawLensDateHistogramDimensionColumnParams | None = None


class KbnRawLensTermsOrderBy(BaseRawVwModel):
...
class KbnRawLensTermsParentFormatParams(BaseRawVwModel):
    """The parameters for the parent format for terms dimension columns."""


class KbnRawLensTermsParentFormat(BaseRawVwModel):
    """The parent format for terms dimension columns."""

    id: Literal['terms', 'multi_terms'] = Field(default='terms')


class KbnRawLensTermsDimensionColumnParams(KbnRawLensDimensionColumnParams):
    """Parameters for terms dimension columns."""

    size: Annotated[int | None, OmitIfNone()] = Field(default=None)
    orderBy: Annotated[KbnRawLensTermsOrderBy | None, OmitIfNone()] = Field(default=None)
    ...
    parentFormat: Annotated[KbnRawLensTermsParentFormat | None, OmitIfNone()] = Field(default=None)
...
class KbnRawLensTermsDimensionColumn(KbnRawLensBaseDimensionColumn):
    ...
    isBucketed: Literal[True] = True
    params: KbnRawLensTermsDimensionColumnParams | None = None


class KbnRawLensFiltersFilter(BaseRawVwModel):
    """Represents a single filter within the filters dimension columns."""

    label: str | None = None
    input: KbnRawQuery | None = None


class KbnRawLensFiltersDimensionColumnParams(KbnRawLensDimensionColumnParams):
    """Parameters for filters dimension columns."""

    filters: list[KbnRawLensFiltersFilter] | None = None


class KbnRawLensFiltersDimensionColumn(KbnRawLensBaseDimensionColumn):
    ...
    scale: Literal['ordinal'] | None = None
    isBucketed: Literal[True] = True
    params: KbnRawLensFiltersDimensionColumnParams | None = None


class KbnRawLensCustomIntervalsDimensionColumnParentFormatParams(BaseRawVwModel):
...
class KbnRawLensCustomIntervalsDimensionColumnParentFormat(BaseRawVwModel):
    """The parent format for intervals dimension columns."""

    id: Literal['range'] | None = None
    params: KbnRawLensCustomIntervalsDimensionColumnParentFormatParams | None = None


class KbnRawLensIntervalsRange(BaseRawVwModel):
...
class KbnRawLensIntervalsDimensionColumnParams(KbnRawLensDimensionColumnParams):
    """Parameters for intervals dimension columns."""

    includeEmptyRows: bool | None = None
    type: Literal['histogram'] = Field(default='histogram')
    ranges: list[KbnRawLensIntervalsRange] | None = None
    maxBars: Annotated[str | float | None, OmitIfNone()] = Field(default=None)
    parentFormat: Annotated[KbnRawLensCustomIntervalsDimensionColumnParentFormat | None, OmitIfNone()] = Field(default=None)


class KbnRawLensIntervalsDimensionColumn(KbnRawLensBaseDimensionColumn):
    ...
    params: KbnRawLensIntervalsDimensionColumnParams | None = None


class KbnRawLensCustomIntervalsDimensionColumnParams(KbnRawLensDimensionColumnParams):
...
class KbnRawLensCustomIntervalsDimensionColumn(KbnRawLensBaseDimensionColumn):
    ...
    isBucketed: Literal[True] = Field(default=True)
    params: KbnRawLensCustomIntervalsDimensionColumnParams | None = None
