...
from kb_dashboard_tools.decompile.kbn_raw_models.panels.charts.base.view import KbnRawLayerColorMapping
from kb_dashboard_tools.decompile.kbn_raw_models.shared.view import BaseRawVwModel, OmitIfNone


class KbnRawTagcloudVisualizationState(BaseRawVwModel):
    """Tagcloud visualization state in Kibana JSON.

    Note: Unlike pie/XY charts, tagcloud uses a flat structure without a layers array. | None = None
