...
class KbnRawBaseFilterMeta(BaseRawVwModel):
...
class KbnRawCombinedFilterMeta(KbnRawBaseFilterMeta):
    ...
    params: Annotated[list['KbnRawFilter'], 'KbnRawFilter', OmitIfNone()] | None = None
    """Parameters for the filter, which can include a list of other filters that are combined."""


class KbnRawFilterMeta(KbnRawBaseFilterMeta):
    """Represents the meta information of a filter in the Kibana JSON structure."""

    type: Literal['phrase', 'phrases', 'range', 'exists'] | None = None
...
class KbnRawCustomFilterMeta(KbnRawBaseFilterMeta):
...
class KbnRawFilterState(BaseRawVwModel):
    """Represents the $state of a filter."""

    store: str = Field(default='appState')


class KbnRawFilter(BaseRawVwModel):
    ...
    state: Annotated[KbnRawFilterState | None, OmitIfNone()] = Field(default=None, validation_alias='$state', serialization_alias='$state')
    meta: Any | None = None
