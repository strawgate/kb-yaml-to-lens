...
::: kb_dashboard.core.panels.base.BasePanel
    options:
      show_source: true
...
::: kb_dashboard.core.panels.markdown.config.MarkdownPanel
    options:
      show_source: true
...
::: kb_dashboard.core.panels.links.config.LinksPanel
    options:
      show_source: true
...
::: kb_dashboard.core.panels.images.config.ImagePanel
    options:
      show_source: true
...
::: kb_dashboard.core.panels.search.config.SearchPanel
    options:
      show_source: true
...
::: kb_dashboard.core.panels.charts.config.LensPanel
    options:
      show_source: true
...
::: kb_dashboard.core.panels.charts.heatmap.config.LensHeatmapChart
    options:
      show_source: true

::: kb_dashboard.core.panels.charts.heatmap.config.ESQLHeatmapChart
    options:
      show_source: true
...
::: kb_dashboard.core.panels.charts.config.ESQLPanel
    options:
      show_source: true
