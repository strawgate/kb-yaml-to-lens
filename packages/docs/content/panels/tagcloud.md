...
::: kb_dashboard.core.panels.charts.tagcloud.config.LensTagcloudChart
    options:
...
::: kb_dashboard.core.panels.charts.tagcloud.config.ESQLTagcloudChart
    options:
      show_root_heading: false
      heading_level: 3
...
::: kb_dashboard.core.panels.charts.tagcloud.config.TagcloudAppearance
    options:
      show_root_heading: false
      heading_level: 3
...
::: kb_dashboard.core.panels.charts.tagcloud.config.TagcloudOrientationEnum
    options:
      show_root_heading: false
      heading_level: 4
