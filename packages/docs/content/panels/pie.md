...
::: kb_dashboard.core.panels.charts.pie.config.LensPieChart
    options:
...
::: kb_dashboard.core.panels.charts.pie.config.PieChartAppearance
    options:
      show_root_heading: false
      heading_level: 3
...
::: kb_dashboard.core.panels.charts.pie.config.PieLegend
    options:
      show_root_heading: false
      heading_level: 3
...
::: kb_dashboard.core.panels.charts.pie.config.PieTitlesAndText
    options:
      show_root_heading: false
      heading_level: 3
...
::: kb_dashboard.core.panels.charts.pie.config.ESQLPieChart
    options:
      show_root_heading: false
      heading_level: 3
