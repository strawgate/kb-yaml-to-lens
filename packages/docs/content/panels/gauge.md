...
::: kb_dashboard.core.panels.charts.gauge.config.LensGaugeChart
    options:
...
::: kb_dashboard.core.panels.charts.gauge.config.GaugeAppearance
    options:
      show_root_heading: false
      heading_level: 3
...
::: kb_dashboard.core.panels.charts.gauge.config.ESQLGaugeChart
    options:
      show_root_heading: false
      heading_level: 3
