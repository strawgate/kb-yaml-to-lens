...
from kb_dashboard.core.controls.compile import compile_control, compile_control_group
from kb_dashboard.core.controls.config import (
    ControlSettings,
    ControlTypes,
...
async def test_options_list_control_returns_reference() -> None:
    ...
    from kb_dashboard.core.controls.compile import compile_options_list_control
    from kb_dashboard.core.controls.config import OptionsListControl
...
async def test_range_slider_control_returns_reference() -> None:
    ...
    from kb_dashboard.core.controls.compile import compile_range_slider_control
    from kb_dashboard.core.controls.config import RangeSliderControl
...
async def test_control_group_returns_references() -> None:
    ...
    from kb_dashboard.core.controls.config import OptionsListControl, RangeSliderControl
