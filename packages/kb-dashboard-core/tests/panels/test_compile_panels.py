...
from kb_dashboard.core.panels.links.config import LinksPanel, LinksPanelConfig, UrlLink
from kb_dashboard.core.panels.markdown.config import MarkdownPanel, MarkdownPanelConfig
from kb_dashboard.core.panels.search.config import SearchPanel, SearchPanelConfig
