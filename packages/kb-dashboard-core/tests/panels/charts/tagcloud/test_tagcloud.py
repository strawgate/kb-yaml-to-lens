...
from kb_dashboard_core.panels.charts.config import ESQLTagcloudPanelConfig
from kb_dashboard_core.panels.charts.tagcloud.compile import (
    compile_esql_tagcloud_chart,
    compile_lens_tagcloud_chart,
)
from kb_dashboard_core.panels.charts.tagcloud.config import LensTagcloudChart
...
def test_tagcloud_static_metric_is_rejected() -> None:
    """Tagcloud metrics must come from aggregations or formulas, not static values."""
