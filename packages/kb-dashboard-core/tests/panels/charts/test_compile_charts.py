...
from kb_dashboard_core.panels.charts.compile import (
...
from kb_dashboard_core.panels.charts.xy.view import XYDataLayerConfig, XYReferenceLineLayerConfig
                ...
                'layers': [
                    {
                        ...
                        'colorMapping': {
                            ...
                            'colorMode': {'type': 'categorical'},
                            'paletteId': 'eui_amsterdam_color_blind',
                            'specialAssignments': [{'color': {'type': 'loop'}, 'rules': [{'type': 'other'}], 'touched': False}],
                        },
                        'layerId': IsUUID,
                        'layerType': 'data',
