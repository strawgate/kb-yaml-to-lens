...
from kb_dashboard.core.panels.charts.compile import (
...
from kb_dashboard.core.panels.charts.view import KbnVisualizationTypeEnum
...
from kb_dashboard.core.panels.charts.xy.view import XYDataLayerConfig, XYReferenceLineLayerConfig
...
class TestCompileESQLChartState:
    ...
    def test_esql_metric_chart_default_time_field(self) -> None:
        ...
        from kb_dashboard.core.panels.charts.config import ESQLPanel
...
class TestCompileChartsPanelConfig:
    ...
    def test_lens_panel_with_hide_title_true(self) -> None:
        ...
        from kb_dashboard.core.panels.charts.config import LensPanel
