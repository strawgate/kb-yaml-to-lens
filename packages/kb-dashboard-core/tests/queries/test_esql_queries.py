...
from kb_dashboard.core.queries.compile import compile_esql_query
from kb_dashboard.core.queries.config import ESQLQuery

if TYPE_CHECKING:
    from kb_dashboard.core.queries.view import KbnESQLQuery
