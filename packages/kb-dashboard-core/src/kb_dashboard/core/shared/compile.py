...
if TYPE_CHECKING:
    from kb_dashboard.core.panels.charts.esql.columns.config import ESQLMetricTypes, ESQLStaticValue
    from kb_dashboard.core.panels.charts.lens.metrics.config import LensMetricTypes, LensStaticValue
