...
from kb_dashboard.core.panels.charts.esql.columns.compile import compile_esql_dimensions, compile_esql_metrics
...
from kb_dashboard.core.panels.charts.lens.dimensions.compile import compile_lens_dimensions
...
from kb_dashboard.core.panels.charts.xy.view import (
    AxisExtentConfig,
