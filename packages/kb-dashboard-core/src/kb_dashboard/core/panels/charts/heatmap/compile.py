...
from kb_dashboard.core.panels.charts.base.config import LegendVisibleEnum
from kb_dashboard.core.panels.charts.esql.columns.compile import compile_esql_dimension, compile_esql_metric
from kb_dashboard.core.panels.charts.heatmap.view import (
    KbnHeatmapGridConfig,
    KbnHeatmapLegendConfig,
    KbnHeatmapVisualizationState,
)
from kb_dashboard.core.panels.charts.lens.dimensions.compile import compile_lens_dimension
from kb_dashboard.core.panels.charts.lens.metrics.compile import compile_lens_metric
from kb_dashboard.core.shared.defaults import default_false
...
if TYPE_CHECKING:
    ...
    from kb_dashboard.core.panels.charts.lens.columns.view import KbnLensColumnTypes, KbnLensMetricColumnTypes
