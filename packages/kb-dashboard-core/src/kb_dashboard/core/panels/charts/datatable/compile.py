...
if TYPE_CHECKING:
    from kb_dashboard.core.panels.charts.esql.columns.view import KbnESQLFieldDimensionColumn

from kb_dashboard.core.panels.charts.datatable.config import (
    DatatableAppearance,
...
from kb_dashboard.core.panels.charts.datatable.view import (
