...
from dashboard_compiler.panels.charts.visualizations.pie.view import (
...
def compile_lens_pie_chart(lens_pie_chart: LensPieChart) -> tuple[str, dict[str, KbnLensColumnTypes], KbnPieVisualizationState]:
    ...
    return layer_id, kbn_columns, compile_pie_chart(layer_id, lens_pie_chart, slice_by_ids, [metric_id])
