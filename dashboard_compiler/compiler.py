...
def compile_dashboard_to_testable_dict(yaml_path: str) -> Dict[str, Any]: # Changed return type hint
    """
...
if __name__ == "__main__":
    ...
    import json
    print(json.dumps(compile_dashboard_to_testable_dict("configs/complex/audit-events-summary.yaml"), indent=2))