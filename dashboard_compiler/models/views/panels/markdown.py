from typing import Any, Literal  # Import Optional

from pydantic import BaseModel, Field

from dashboard_compiler.models.views.base import KbnBasePanel, KbnBasePanelEmbeddableConfig  # Import base view models
