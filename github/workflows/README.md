...
mv github/workflows/auto-label-triage.yml .github/workflows/
...
### `auto-label-triage.yml`

- **Purpose:** Automatically adds the `triage` label to all newly opened issues
- **Trigger:** `issues: opened` event
- **Benefit:** Ensures all new issues are consistently labeled for triage tracking
