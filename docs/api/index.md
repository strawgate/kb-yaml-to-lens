...
The Dashboard Compiler supports various panel types. For detailed examples and API reference for each panel type, see the **[Panels](panels.md)** documentation.

**Available Panel Types:**

- **[Markdown Panels](panels.md#markdown-panels)** - Display rich text content
- **[Metric Charts](panels.md#metric-charts)** - Display key performance indicators (KPIs)
- **[Pie Charts](panels.md#pie-charts)** - Show distribution of categorical data
- **[XY Charts](panels.md#xy-charts)** - Create line, bar, and area charts for time series data
- **[Links Panels](panels.md#links-panels)** - Display collections of links
- **[Image Panels](panels.md#image-panels)** - Embed images in dashboards
- **[Search Panels](panels.md#search-panels)** - Display search results
