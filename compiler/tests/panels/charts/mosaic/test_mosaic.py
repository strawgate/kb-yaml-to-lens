...
async def test_mosaic_chart_with_secondary_groups() -> None:
    """Test mosaic chart with secondary groups (multi-dimensional)."""
    lens_config = {
        'type': 'mosaic',
        'data_view': 'logs-*',
        'metrics': [{'aggregation': 'sum', 'field': 'bytes', 'id': '8f020607-379e-4b54-bc9e-e5550e84f5d5'}],
        'dimensions': [
            {'type': 'values', 'field': 'geo.src', 'id': '6e73286b-85cf-4343-9676-b7ee2ed0a3df', 'size': 5},
            {'type': 'values', 'field': 'geo.dest', 'id': '7f84397c-95f0-5454-bd88-c8ff3fe1b4eg', 'size': 5},
        ],
        'color': {'palette': 'eui_amsterdam_color_blind'},
    }
    esql_config = {
        'type': 'mosaic',
        'query': 'FROM logs-* | STATS bytes = SUM(bytes) BY geo.src, geo.dest',
        'metrics': [{'field': 'bytes', 'id': '8f020607-379e-4b54-bc9e-e5550e84f5d5'}],
        'dimensions': [
            {'field': 'geo.src', 'id': '6e73286b-85cf-4343-9676-b7ee2ed0a3df'},
            {'field': 'geo.dest', 'id': '7f84397c-95f0-5454-bd88-c8ff3fe1b4eg'},
        ],
        'color': {'palette': 'eui_amsterdam_color_blind'},
    }
