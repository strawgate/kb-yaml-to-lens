...
def compile_lens_datatable_chart(
    ...
    for breakdown in lens_datatable_chart.breakdowns:
        breakdown_id, compiled_breakdown = compile_lens_dimension(dimension=breakdown, kbn_metric_column_by_id=kbn_metric_columns_by_id)
    ...
    visualization_state = KbnDatatableVisualizationState(
        ...
        rowHeight=lens_datatable_chart.row_height if lens_datatable_chart.row_height != 'auto' else None,
        headerRowHeight=lens_datatable_chart.header_row_height if lens_datatable_chart.header_row_height != 'auto' else None,
        rowHeightLines=lens_datatable_chart.row_height_lines,
        headerRowHeightLines=lens_datatable_chart.header_row_height_lines,
        paging=paging_state,
        density=lens_datatable_chart.density if lens_datatable_chart.density != 'normal' else None,
    )
...
def compile_esql_datatable_chart(
    ...
    visualization_state = KbnDatatableVisualizationState(
        ...
        layerType='data',
        sorting=sorting_state,
        rowHeight=esql_datatable_chart.row_height if esql_datatable_chart.row_height != 'auto' else None,
        headerRowHeight=esql_datatable_chart.header_row_height if esql_datatable_chart.header_row_height != 'auto' else None,
        rowHeightLines=esql_datatable_chart.row_height_lines,
        headerRowHeightLines=esql_datatable_chart.header_row_height_lines,
        paging=paging_state,
        density=esql_datatable_chart.density if esql_datatable_chart.density != 'normal' else None,
    )
