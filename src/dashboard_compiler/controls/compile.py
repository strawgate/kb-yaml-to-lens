...
def compile_esql_static_values_control(order: int, *, control: ESQLStaticValuesControl) -> KbnESQLControl:
    ...
    return KbnESQLControl(
        ...
        explicitInput=KbnESQLControlExplicitInput(
            ...
            variableType=str(control.variable_type),
            esqlQuery='',
...
def compile_control(order: int, *, control: ControlTypes) -> KbnControlTypes:
    ...
    if isinstance(control, ESQLStaticValuesControl):
        return compile_esql_static_values_control(order, control=control)
