...
async def test_compile_xy(in_lens_config: dict, in_esql_config: dict, out_lens_shape: dict, out_layer: dict) -> None:  # noqa: ARG001
    """Test the compilation of various Lens xy configurations to their Kibana view model."""
    lens_chart = LensXYChartHolder.model_validate(in_lens_config)
    ...
    esql_chart = ESQLXYChartHolder.model_validate(in_esql_config)
