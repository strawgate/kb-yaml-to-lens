...
async def test_compile_metric(in_lens_config: dict, in_esql_config: dict, out_layer: dict) -> None:
    ...
    layer_id, kbn_columns_by_id, kbn_state_visualization = compile_lens_metric_visualization(lens_metric_chart=lens_chart)
    ...
    layer_id, kbn_columns, kbn_state_visualization = compile_esql_metric_visualization(esql_metric_chart=esql_chart)
